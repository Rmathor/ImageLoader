package com.mathor.imageloader.view;
...
import com.mathor.imageloader.ImageDetailsActivity;
import com.mathor.imageloader.ImageLoader;
import com.mathor.imageloader.MainActivity;
import com.mathor.imageloader.R;
import com.mathor.imageloader.domain.Images;
...
public class MyScrollView extends ScrollView implements View.OnTouchListener {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !loadOnce) {
            ...
            loadOnce = true;
            //动态获取读取sdcard数据权限
            if (isGrantExternalRW(mainActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                loadMoreImages();
            }
        }
    }
...
//            }
     ...
     * @return
     */
    public static boolean isGrantExternalRW(Activity activity, String permission) {
